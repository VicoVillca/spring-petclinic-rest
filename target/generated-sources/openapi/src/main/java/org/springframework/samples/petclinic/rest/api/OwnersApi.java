...
public interface OwnersApi {
    ...
    default ResponseEntity<PetDto> addPetToOwner(
        @Min(value = 0) @Parameter(name = "ownerId", description = "The ID of the pet owner.", required = true, in = ParameterIn.PATH) @PathVariable("ownerId") Integer ownerId,
    ...
    default ResponseEntity<VisitDto> addVisitToOwner(
        @Min(value = 0) @Parameter(name = "ownerId", description = "The ID of the pet owner.", required = true, in = ParameterIn.PATH) @PathVariable("ownerId") Integer ownerId,
        @Min(value = 0) @Parameter(name = "petId", description = "The ID of the pet.", required = true, in = ParameterIn.PATH) @PathVariable("petId") Integer petId,
    ...
    default ResponseEntity<OwnerDto> deleteOwner(
        @Min(value = 0) @Parameter(name = "ownerId", description = "The ID of the owner.", required = true, in = ParameterIn.PATH) @PathVariable("ownerId") Integer ownerId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
