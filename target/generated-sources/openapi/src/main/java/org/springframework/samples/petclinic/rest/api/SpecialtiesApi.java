...
public interface SpecialtiesApi {
    ...
    default ResponseEntity<SpecialtyDto> deleteSpecialty(
        @Min(value = 0) @Parameter(name = "specialtyId", description = "The ID of the specialty.", required = true, in = ParameterIn.PATH) @PathVariable("specialtyId") Integer specialtyId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<SpecialtyDto> getSpecialty(
        @Min(value = 0) @Parameter(name = "specialtyId", description = "The ID of the speciality.", required = true, in = ParameterIn.PATH) @PathVariable("specialtyId") Integer specialtyId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
